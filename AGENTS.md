...
4. **ALWAYS Read MEMORY.md**: This contains your Global Long-Term Memory. Load it in **ALL SESSIONS** and **ALL CHAT WINDOWS** to maintain continuity with your Master (诗琪大魔王).
...
### 🧠 MEMORY.md - Your Global Shared Memory
